 ...
 */
async function getUserTopTracks(userId) {
    try {
 ...
 */
async function generateQuestionsFromSpotify(userId, count = 10) {
    try {
...
// Export the functions using CommonJS format
module.exports = {
    getValidSpotifyToken,
    getUserTopTracks,
    getUserTopArtists,
    getArtistAlbums,
    generateQuestionsFromSpotify
};